...
-- 請求明細
--* BackupToTempTable
drop table seikyu_detail cascade;
...
-- 顧客案件
--* BackupToTempTable
drop table company_anken cascade;
...
-- 提案履歴
--* BackupToTempTable
drop table teian_history cascade;
...
-- メール送信先リスト
--* BackupToTempTable
drop table mail_send_list cascade;
...
-- エンジニアスキル管理
--* BackupToTempTable
drop table engineer_skill cascade;
...
-- 顧客概評履歴
--* BackupToTempTable
drop table NEW_ENTITY1 cascade;
